(function (window) {
	var Action003 = function(battleController, owner) {
		this.bc = battleController;
		this.initialize(owner);
	}
	var a = Action003.prototype = new BattleControllerAction();
	a.initialize = function(owner) {
		...
		this.card_img_name = "neurolyse";
		this.mini_img_name = "small_neurolyse";
	...
	Action003.prototype.getTriggerData = function() {
		return null;
	}
	Action003.prototype.canTrigger = function() {
		return false;
	}
	Action003.prototype.trigger = function() {
	...
	Action003.prototype.getActivateData = function() {
		return null;
	}
	Action003.prototype.canActivate = function() {
		return false;
	}
	Action003.prototype.activate = function() {
	...
	Action003.prototype.getUseData = function(unit) {
		use = {
	...
	*/
	...
	Action003.prototype.getResolveData = function(unit) {
